...
Hay al menos dos formas de cargar una base de datos si estás usando RStudio. Una es con el botón "Import Dataset", que está en la ventana superior derecha en RStudio. Ahí se selecciona "From text", para cargar el archivo. También hay opción para cargar desde Excel o desde programas como Stata o SPSS.
...
df[df$Producto_ID == 5,]
```
En el primero, sólo muestra el primer dato de la primera columna.
```
